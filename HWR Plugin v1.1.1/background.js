...
chrome.webRequest.onBeforeRequest.addListener(
	...
	function(details) {
		...
		if (window == top && (localStorage[_enableKey] === 'true' || localStorage[_enableKey] == undefined) ) {
...
chrome.webRequest.onBeforeRequest.addListener(
    ...
    { urls: ["http://www.instant-gaming.com/*", "https://www.instant-gaming.com/*", "https://www.press-start.com/*", "https://www.press-start.com/*"] }, // only run for requests to the following urls
    ['blocking']    // blocking permission necessary in order to perform the redirect
);
